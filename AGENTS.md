...
13. Any relevant `docs/` or `specs/` file
...
- The unified 150-test suite passes in about 90 seconds on the milestone machine; chart end-to-end passes 16/16 in about 35 seconds.
